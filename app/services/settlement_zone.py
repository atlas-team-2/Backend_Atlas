...
class SettlementZoneService:
    ...
    async def update_settlement_zone(
        self, zone_id: UUID, settlement_zone_update: SettlementZoneUpdate
    ) -> Optional[SettlementZone]:
